...
class XmlBasedRobot:
  ...
  def addToScene(self, bullet_client, bodies):
    #todo sha: It seems that it's a private method, so I change its name to _addToScene
    #no, it's not private method, it has been used in env.reset
