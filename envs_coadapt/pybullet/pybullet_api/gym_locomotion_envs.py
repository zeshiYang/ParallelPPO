...
class WalkerBaseBulletEnv(MJCFBaseBulletEnv):
  ...
  def seed(self, seed=0):#todo sha: I changed the seed from None as in original pybullet env to 0.
  ...
  def reset(self):
    ...
    for _ in range(200): #todo, what's it?
...
class HalfCheetahBulletEnv(WalkerBaseBulletEnv):
  ...
  def step(self, a):
    ...
    reward = max(state[-5]/10.0, 0.0) #todo, here state[-5] refers to the xv
    #todo another project features
